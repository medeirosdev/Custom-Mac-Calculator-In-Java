...
public class Teclado extends JPanel implements ActionListener {
	//JPanel é um componente menor do JFrame
	private final Color COR_CINZA_ESCURO = new Color(68, 68, 68);
	private final Color COR_CINZA_CLARO = new Color(127, 0, 255);
	private final Color COR_LARANJA = new Color(51, 51, 255);
	...
	private void adicionarBotao(String texto, Color cor, 
		...
		//Adiciona o Action Listener ao button, e quando for acionado
		// irá executar o script do actionPerfomed
		add(botao, c);
	}
	...
	public void actionPerformed(ActionEvent e) {
		if(e.getSource() instanceof JButton) {
			...
			//o getText -> ele irá pegar o texto do botão
